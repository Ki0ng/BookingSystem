  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1449156001433-3d0692290f67?q=80&w=1974&auto=format&fit=crop")',
        ...
        <div className="bg-white/10 backdrop-blur-2xl p-10 rounded-[2.5rem] shadow-2xl border border-white/20 animate-in fade-in slide-in-from-top-12 duration-700">
          ...
          <div className="space-y-3 text-center mb-10">
            <h1 className="text-3xl font-black text-white tracking-tight uppercase">
              Secure <span className="text-blue-400">Account</span>
            </h1>
          ...
          {!message && token && (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-200 ml-1 uppercase tracking-[0.2em]">New Password</label>
                <Input
                  type="password"
                  placeholder="••••••••"
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-200 ml-1 uppercase tracking-[0.2em]">Confirm Password</label>
                <Input
                  type="password"
                  placeholder="••••••••"
                  className="bg-white/5 border-white/10 text-white placeholder:text-gray-500 h-14 rounded-2xl focus:ring-blue-500 focus:bg-white/10 transition-all"
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-slate-900 text-white font-black uppercase tracking-widest animate-pulse">Initializing Security...</div>}>
      <ResetPasswordForm />
    </Suspense>
  );
}
