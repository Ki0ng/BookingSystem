  ...
  return (
    <section className="relative min-h-[90vh] flex items-start justify-center">
      ...
      <div className="relative z-40 w-full max-w-7xl px-6 flex flex-col items-center text-center pt-32 pb-20">
        <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tighter leading-[1.1] mb-8 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100 uppercase">
          Discover the <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-300 to-blue-200">Unimaginable</span>
        </h1>

        <p className="text-base md:text-lg text-white/80 font-medium max-w-2xl mx-auto mb-16 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
